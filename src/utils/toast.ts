...
const loading = <T>(promise: Promise<T>, params: Toast.LoadingParams<T>): Toast.ID => {
  return sonner.promise(promise, { loading: params.label, success: 'Success', error: 'Error', ...params });
};
